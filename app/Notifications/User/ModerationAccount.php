...
class ModerationAccount extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('email.moderation_subject'))
            ->line(__('email.moderation_text', ['name' => $notifiable->name]))
