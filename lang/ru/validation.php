...
$attributes = [
    ...
    'categories_selected' => "Категории работ",
    'categories_selected.*' => "Одна из категорий работ",
    'name' => "Имя",
    "title" => "Название",
    "content" => "Контент",
    "city_id" => "Город",
    ...
    "payment_type" => "Оплата",
    "price" => "Стоимость",
    "payment_per" => "Измерение оплаты",
    "need_count_workers" => "Количество человек",
    "images" => "Фото",
    "images.*" => "Одно из фото",
];
...
return [
    ...
    'phone' => 'Значение поля :attribute должно быть номером телефона в международном формате',
